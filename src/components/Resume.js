        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="certification-card p-6 bg-gray-900 rounded-lg">
              <img src="/quick-heal-badge.png" alt="Quick Heal Certification" className="w-48 h-48 mx-auto mb-4 object-contain" />
            ...
            <div className="certification-card p-6 bg-gray-900 rounded-lg">
              <img src="/security-plus-badge.png" alt="CompTIA Security+" className="w-48 h-48 mx-auto mb-4 object-contain" />
              <h4 className="text-lg text-center">CompTIA Security+</h4>
              <p className="text-gray-400 text-center">January 2025</p>
            </div>

            <div className="certification-card p-6 bg-gray-900 rounded-lg">
              <img src="/network-plus-badge.png" alt="CompTIA Network+" className="w-48 h-48 mx-auto mb-4 object-contain" />
